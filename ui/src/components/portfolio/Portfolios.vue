        ...
        methods: {
            ...
            updateTable(profileData) {
                if (profileData) {
                    ...
                    axios.get('/tradr/portfolio/', {headers: {'Authorization': 'Bearer ' + this.$jwt.getToken()}})
                        .then(response => {
                        ...
                        .catch(e => {
                            ...
                            axios.get('/tradr/portfolio/', {headers: {'Authorization': 'Bearer '+localStorage.getItem("user_jwt")}})
                                .then(response => {
                                    for (var i in response.data) {
                                        console.log(response.data[i]);
                                        this.data.push(response.data[i]);
