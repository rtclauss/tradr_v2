...
export default {
    ...
    methods: {
        ...
        getPortfolio(user) {
            ...
            axios.get('/tradr/portfolio/' + user, {headers: {'Authorization': 'Bearer ' + this.$jwt.getToken()}})
                .then(response => {
        ...
        getPortfolioReturns(user) {
            ...
            axios.get('/tradr/portfolio/' + user + '/returns', {headers: {'Authorization': 'Bearer ' + this.$jwt.getToken()}})
                .then(response => {
